...
remaining_tokens := r if {
    r := input.monthly_token_limit - input.monthly_tokens_used
}

remaining_cost_usd := r if {
    r := input.monthly_cost_limit_usd - input.monthly_cost_usd
}
